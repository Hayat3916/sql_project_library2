...
![Library_project](https://github.com/Hayat3916/sql_project_library2/blob/main/Library.jpg)
...
### 1. Database Setup
![ERD](https://github.com/Hayat3916/sql_project_library2/blob/main/library_erd.png)
...
1. **Clone the Repository**: Clone this repository to your local machine.
   ```sh
   git https://github.com/Hayat3916/sql_project_library2---P2.git
   ```
...
## Author - Hayat Mohammad Khan

This project showcases SQL skills essential for database management and analysis. For more content on SQL and data analysis, connect with me through the following channels:

- **LinkedIn**: [Connect with me professionally](https://www.linkedin.com/in/hayat-mohammad-khan-6427ab190)
